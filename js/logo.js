/* ============================================================
   ...
   beats
     ...
     2.40  hold
     4.00  wordmark and dates leave
     4.15  the mark shrinks onto the centre
     4.95  ---- the logo is fully gone ----
     5.05  the rule draws out of that same point
     5.30  the seed lands on the rule  -> hands off to the timeline
...
var SCENE_LOGO = (function () {
  ...
  function render(t) {
    ...
    var mShr   = A.ease(t, 4.15, 0.70, A.easeInOutCubic);
    var mFade  = A.ease(t, 4.60, 0.35, A.easeInCubic);
    ...
    var wOut = A.ease(t, 4.00, 0.40, A.easeInCubic);
    ...
    var dOut = A.ease(t, 4.00, 0.40, A.easeInCubic);
  ...
  return {
    ...
    markers: [0.00, 0.35, 1.10, 1.70, 2.40, 4.00, 4.15, 5.05, 5.30, 6.10],
    selector: "#scene-logo",
    init: init,
    render: render
  };
